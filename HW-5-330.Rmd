...
$\beta_5$: Life expencatncy is expected to increase by $\beta_5 + \beta_3$ more for an OECD country than a country in group other as log(PPGDP) goes up by 1.
...
$\beta_1$: Holding all else contstant and being in group other, as log(PPGDP) goes up by 1, the life expectancy goes up by 2.94, on average.

$\beta_2$: For equal log(PPGDP) levels, a country in group Africa has a 11.9 lower life expectancy than a country in group "other", on average. 

$\beta_3$: For equal log(PPGDP) levels, a country in group oecd has a 11.29 higher life expectancy than a country in group "other", on average. 

$\beta_4$: Life expencatncy is expected to decrease by 11.9 + 0.04 or 11.94 if a group changes from other to African and the log(PPGDP) goes up by 1.

$\beta_5$: Life expencatncy is expected to increase by 11.29 - 0.95 or 10.34 if a group changes from other to African and the log(PPGDP) goes up by 1.
...
For the interaction between log(PPGDP) and Group:OECD we are 95% confident that life expectancy will decrease between 1.57 and .335 for countires that change from other to the OECD when the log(PPGDP) goes up by 1.
